...
$thinPages = @("mortgage.html", "ir35.html", "stamp-duty.html", "dividend.html", "password.html", "image.html", "color-picker.html", "working-days.html", "fuel.html", "weight.html")
...
foreach ($page in $thinPages) {
  Assert-True ((Read-SiteFile $page) -match '<meta\s+name=["'']robots["'']\s+content=["''][^"'']*noindex,follow') "$page is not noindex,follow"
}
...
$expectedLocs = @("https://mini-tools.uk/", "https://mini-tools.uk/upload", "https://mini-tools.uk/tax", "https://mini-tools.uk/privacy", "https://mini-tools.uk/contact", "https://mini-tools.uk/about")
